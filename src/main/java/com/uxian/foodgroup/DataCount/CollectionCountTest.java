...
public class CollectionCountTest {
	...
	private static final Logger log = Logger.getLogger(CollectionCountTest.class);
	...
	public void setUp() throws UnsupportedEncodingException {
		...
		actionUrl = "/api/DataCount/CollectionCount";
	...
	public void collectionCountTest(String testName, String foodPostID, String expectedRes) {
