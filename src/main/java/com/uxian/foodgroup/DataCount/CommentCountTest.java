...
public class CommentCountTest {
	...
	private static final Logger log = Logger.getLogger(CommentCountTest.class);
	...
	public void setUp() throws UnsupportedEncodingException {
		...
		actionUrl = "/api/DataCount/CommentCount";
	...
	public void commentCountTest(String testName, String foodPostID, String expectedRes) {
