...
public class CollectionFoodPostsTest {
	...
	private static final Logger log = Logger.getLogger(CollectionFoodPostsTest.class);
	
	@DataProvider(name = "getData")
	private Object[][] getData() {
		return new Object[][] {{"查看我的收藏帖子列表", 1, 3, "Success", 3 } };
	...
	public void setUp() throws UnsupportedEncodingException {
		...
		actionUrl = "/api/FoodPost/CollectionFoodPosts";
		
	}
	
	@AfterClass
	public void tearDown() {
		log.info("我的收藏帖子列表接口测试结束！");
	}
	
	@Test(dataProvider = "getData")
	public void collectionFoodPostsTest(String testName, int pageNumber, int pageSize, String expectedRes, int expectedCount) {
