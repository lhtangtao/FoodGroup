...
public class FoodPostCollectionTest {
	...
	private static final Logger log = Logger.getLogger(FoodPostCollectionTest.class);
	
	@DataProvider(name = "getData")
	private Object[][] getData() {
		return new Object[][] {{"输入存在的帖子ID", foodPostID, "Success", "凑数的" }, {"输入已经被收藏的帖子ID", FoodPostID2, "Failed", "Collection" },
	...
	public void setUp() throws UnsupportedEncodingException {
		...
		actionUrl = "/api/FoodPostOperator/FoodPostCollection";
